      ...
      {isLoading ? (
        ...
        <>
          <div className="flex items-center">
            ...
            <span className="bg-pink-500 transition-all duration-500 hover:bg-slate-800 cursor-pointer rounded-full py-2 text-sm text-white px-4">
                        ...
                        <td className="py-4 px-6 text-start">
                          <div className="flex items-center gap-2">
                            <StarRatings
                              ...
                              starSpacing="1px"
                            />
                            <span className="text-pink-500 font-semibold mt-1.5">
                              {review.stars}{" "}
