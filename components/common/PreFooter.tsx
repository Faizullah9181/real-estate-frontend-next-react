...
const PreFooter = () => {
  ...
  return (
    <div className="bg-slate-800">
      <div className="bg-pink-500 rounded w-4/5 relative bottom-24 mx-auto p-8 md:p-12">
        <footer
          id="pre_footer"
        ...
        >
          <div className="pre-footer-left flex flex-col gap-8">
            ...
            <p className="text-white text-center lg:text-start">
              We can help you realize your dream of a new home get in touch with us instantly!
            </p>
          </div>
