...
const IconBottomCard = ({ headerIcon, text, link, footerIcon }: Proptypes) => {
  ...
  return (
    <Link href={link}>
      <div
        className="shadow-xl relative flex flex-col gap-8 hover:text-white items-center transition-all hover:bg-pink-500 cursor-pointer justify-center rounded-md py-16"
