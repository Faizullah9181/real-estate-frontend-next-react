      ...
      <Link href={"/property/" + property._id}>
        <Card className="mx-4">
          ...
          <CardBody className="text-center">
            <Typography
              variant="h6"
              className="my-2 text-start poppins text-pink-500 font-bold"
            >
          ...
          >
            ...
            <div className="icons flex w-full justify-end gap-2">
              <i className="fa-solid w-full text-center md:w-fit fa-arrow-up-right-from-square text-white text-lg px-3 py-2 rounded-full bg-pink-500"></i>
              <i
                onClick={(e) => handleOpen("lg", e)}
                className="fa-solid hidden md:block fa-eye cursor-pointer text-white text-lg px-3 py-2 rounded-full bg-pink-500"
              ></i>
            </div>
          </CardFooter>
        </Card>
