          ...
          {user ? (
            <>
              <Link
                ...
                onClick={() => setPopover(!popover)}
                className="text-black hover:text-pink-500 transition-all duration-300 border-b-2 hover:border-pink-500 pb-2 px-8 text-sm block my-6 font-semibold "
              >
                Properties
              </Link>
              <Link
              ...
              <div
                ...
                className="text-black hover:text-pink-500 cursor-pointer transition-all duration-300 border-b-2 hover:border-pink-500 pb-2 px-8 text-sm block my-6 font-semibold "
              >
                Logout
              </div>
            </>
